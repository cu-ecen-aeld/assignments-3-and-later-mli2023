...
cd ${OUTDIR}/rootfs
mkdir dev proc sys home tmp lib lib64 var usr bin sbin etc
...
echo "Busybox installed in ${OUTDIR}/rootfs/bin"
cd ${OUTDIR}/rootfs
...
GCC_PATH=$(dirname $(which aarch64-none-linux-gnu-gcc))
cd ${GCC_PATH}/../aarch64-none-linux-gnu
